--[[
   ...
   ─
│@V_P_E
تم تطوير السورس بواسطه مطور سورس جاك ✾
#-------------------------------------------------------------------
]]
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(ELMOSLM..":NameBot:")
...
var = 'مطور اساسي' 
elseif  UserID == 1236115319 then
var =   'مبرمج السورس' 
elseif  UserID == 835551362 then
var =  'مطور السورس'
elseif redis:sismember(ELMOSLM..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(ELMOSLM..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(ELMOSLM..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(ELMOSLM..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(ELMOSLM..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(ELMOSLM..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(ELMOSLM..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(ELMOSLM..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(ELMOSLM..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(ELMOSLM..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(ELMOSLM..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(ELMOSLM..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(ELMOSLM..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(ELMOSLM..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(ELMOSLM..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(ELMOSLM..':SUDO_BOT:')
message = '⋆ ** قائمه الـمـطـوريـن : \n\n`⋆ مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(ELMOSLM..'username:'..v)
local count = redis:scard(ELMOSLM..'mtwr_count'..v)
...
local monsha = redis:smembers(ELMOSLM..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n⋆ قائمه المدراء :*\n\n'
local list = redis:smembers(ELMOSLM..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(ELMOSLM..'admins:'..msg.chat_id_)
...
local list = redis:smembers(ELMOSLM..'whitelist:'..msg.chat_id_)
...
if redis:sismember(ELMOSLM..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(ELMOSLM..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(ELMOSLM..'banned:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(ELMOSLM..'banned:'..msg.chat_id_)
...
if redis:sismember(ELMOSLM..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(ELMOSLM..'gban_users')
...
local list = redis:smembers(ELMOSLM..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(ELMOSLM..':Filter_Word:'..msg.chat_id_,word) then 
return  "⋆ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(ELMOSLM..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(ELMOSLM..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(ELMOSLM..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(ELMOSLM..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(ELMOSLM..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(ELMOSLM..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(ELMOSLM..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
json_data = '{"BotID": '..ELMOSLM..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(ELMOSLM..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(ELMOSLM..'group:name'..GroupS) or '')
...
local admins = redis:smembers(ELMOSLM..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(ELMOSLM..'username:'..value)
if info then 
...
local creators = redis:smembers(ELMOSLM..':MONSHA_BOT:'..GroupS)
if #creators ~= 0 then
...
local creator = redis:smembers(ELMOSLM..':KARA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(ELMOSLM..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(ELMOSLM..'group:ids')
message = '⋆ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(ELMOSLM..'group:name'..v)
if info then 
...
redis:del(
ELMOSLM..'group:add'..id_group,
ELMOSLM..'lock_link'..id_group, 
ELMOSLM..'lock_id'..id_group,
ELMOSLM..'lock_spam'..id_group, 
ELMOSLM..'lock_webpage'..id_group,
ELMOSLM..'lock_markdown'..id_group,
ELMOSLM..'lock_flood'..id_group,
ELMOSLM..'lock_bots'..id_group,
ELMOSLM..'mute_forward'..id_group,
ELMOSLM..'mute_contact'..id_group,
ELMOSLM..'mute_location'..id_group,
ELMOSLM..'mute_document'..id_group,
ELMOSLM..'mute_keyboard'..id_group,
ELMOSLM..'mute_game'..id_group,
ELMOSLM..'mute_inline'..id_group,
ELMOSLM..'lock_username'..id_group,
ELMOSLM..'num_msg_ELMOSLM'..id_group,
ELMOSLM..'replay'..id_group
)
redis:srem(ELMOSLM..'group:ids',id_group)
end
...
redis:hset(ELMOSLM..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(ELMOSLM..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
function modadd(msg)
if redis:get(ELMOSLM..'lock_service') then
service = true
Get_Director = 30
else
service = false
...
if redis:get(ELMOSLM..'group:add'..msg.chat_id_) then  return '⋆ **المجموعة تم تفعيلها مُسبقاً . ' end

local UserChaneel = redis:get(ELMOSLM..":UserNameChaneel")
...
redis:setex(ELMOSLM..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(ELMOSLM..':addnumberusers') or 0)
...
local lock_service = redis:get(ELMOSLM..'lock_service')
if lock_service then 
sendMsg(msg.chat_id_,msg.id_,'⋆*تم تفعيل المجموعه . \n*⋆ ورفع كل المشرفين\n [SOURCE ELMOSLM](t.me/Xx_SorceELMOSLM_xX)')
else
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(ELMOSLM..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(ELMOSLM..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
ELMOSLM..'group:add'..msg.chat_id_,true,
ELMOSLM..'lock_link'..msg.chat_id_,true, 
ELMOSLM..'lock_id'..msg.chat_id_,true,
ELMOSLM..'lock_spam'..msg.chat_id_,true,
ELMOSLM..'lock_webpage'..msg.chat_id_,true,
ELMOSLM..'lock_markdown'..msg.chat_id_,true,
ELMOSLM..'lock_flood'..msg.chat_id_,true,
ELMOSLM..'lock_bots'..msg.chat_id_,true,
ELMOSLM..'mute_forward'..msg.chat_id_,true,
ELMOSLM..'mute_contact'..msg.chat_id_,true,
ELMOSLM..'mute_location'..msg.chat_id_,true,
ELMOSLM..'mute_document'..msg.chat_id_,true,
ELMOSLM..'mute_keyboard'..msg.chat_id_,true,
ELMOSLM..'mute_game'..msg.chat_id_,true,
ELMOSLM..'mute_inline'..msg.chat_id_,true,
ELMOSLM..'lock_username'..msg.chat_id_,true,
ELMOSLM..'num_msg_ELMOSLM'..msg.chat_id_,5, 
ELMOSLM..'replay'..msg.chat_id_,true
)

redis:sadd(ELMOSLM..'group:ids',msg.chat_id_) 
redis:sadd(ELMOSLM..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(ELMOSLM..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(ELMOSLM..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(ELMOSLM..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(ELMOSLM..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(ELMOSLM..'username:'..UserID,'username',Resolv)
redis:sadd(ELMOSLM..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(ELMOSLM..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(ELMOSLM..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(ELMOSLM..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(ELMOSLM..'username:'..UserID,'username',Resolv)
redis:sadd(ELMOSLM..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(ELMOSLM..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(ELMOSLM..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(ELMOSLM..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(ELMOSLM..'username:'..UserID, 'username', Resolv)
redis:sadd(ELMOSLM..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(ELMOSLM..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(ELMOSLM..'whitelist:'..ChatID,UserID)
...
if redis:sismember(ELMOSLM..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(ELMOSLM..'username:'..UserID, 'username', Resolv)
redis:sadd(ELMOSLM..'owners:'..ChatID,UserID)
...
if redis:sismember(ELMOSLM..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(ELMOSLM..'username:'..UserID, 'username', Resolv)
redis:sadd(ELMOSLM..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(ELMOSLM..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(ELMOSLM..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(ELMOSLM..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(ELMOSLM..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(ELMOSLM..'msgs:'..UserID..':'..ChatID) or 1
...
elseif UserID == 835551362 then 
return sendMsg(ChatID,MsgID,"⋆ **ده بابا عيب\n")
elseif UserID == 1236115319 then 
return sendMsg(ChatID,MsgID,"⋆ **ده بابا عيب\n") 
elseif redis:sismember(ELMOSLM..':SUDO_BOT:',UserID) then 
...
redis:hset(ELMOSLM..'username:'..UserID, 'username', Resolv)
redis:sadd(ELMOSLM..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(ELMOSLM..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(ELMOSLM..'banned:'..ChatID,UserID)
...
if redis:sismember(ELMOSLM..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(ELMOSLM..'username:'..UserID, 'username', Resolv)
redis:sadd(ELMOSLM..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(ELMOSLM..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(ELMOSLM..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(ELMOSLM..'username:'..UserID, 'username',Resolv)
redis:sadd(ELMOSLM..'gban_users',UserID)
...
redis:srem(ELMOSLM..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم الغاء حظره العام \n',17,USERCAR) 
end
...
if redis:sismember(ELMOSLM..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(ELMOSLM..'username:'..UserID, 'username', Resolv)
redis:sadd(ELMOSLM..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(ELMOSLM..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(ELMOSLM..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
redis:hset(ELMOSLM..'username:'..UserID, 'username', UserName)
redis:sadd(ELMOSLM..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(ELMOSLM..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'⋆ **العضو » ❪ '..UserName..' ❫\n⋆ **الايدي » ❪ `'..UserID..'` ❫\n⋆ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(ELMOSLM..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(ELMOSLM..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(ELMOSLM..'admins:'..ChatID,UserID) then 
...
return sendMsg(ChatID,MsgID,"⋆ ** لا يوجد عضـو بهذا المعرف \n")
end 
...
Restrict(ChatID,UserID,1)
redis:hset(ELMOSLM..'username:'..UserID, 'username', Resolv)
redis:sadd(ELMOSLM..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(ELMOSLM..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(ELMOSLM..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'⋆ **العضو » '..USERNAME..' \n⋆ ** الايدي » (`'..UserID..'`)\n⋆ **انه بالتأكيد ليس مطور \n') end
redis:srem(ELMOSLM..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(ELMOSLM..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(ELMOSLM..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(ELMOSLM..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(ELMOSLM..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*⋆*` اعدادات المجموعه :` \n"
.."\n⋆ التعديل «» "..(redis:get(ELMOSLM..'lock_edit'..msg.chat_id_) or 'false')
.."\n⋆ الروابط «» "..(redis:get(ELMOSLM..'lock_link'..msg.chat_id_) or 'false')
.."\n⋆ التاك «» "..(redis:get(ELMOSLM..'lock_tag'..msg.chat_id_) or 'false')
.."\n⋆ المعرفات «» "..(redis:get(ELMOSLM..'lock_username'..msg.chat_id_) or 'false')
.."\n⋆ التكرار «» "..(redis:get(ELMOSLM..'lock_flood'..msg.chat_id_) or 'false')
.."\n⋆ الكلايش «» "..(redis:get(ELMOSLM..'lock_spam'..msg.chat_id_) or 'false')
.."\n⋆ الويب «» "..(redis:get(ELMOSLM..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⋆ الماركدوان «» "..(redis:get(ELMOSLM..'lock_markdown'..msg.chat_id_) or 'false')
.."\n⋆ بالطرد البوتات «» "..(redis:get(ELMOSLM..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n⋆ البوتات «» "..(redis:get(ELMOSLM..'lock_bots'..msg.chat_id_) or 'false')
.."\n⋆ عدد التكرار «» "..(redis:get(ELMOSLM..'num_msg_ELMOSLM'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⋆`اعدادات الوسائط :`\n"
.."\n*⋆ *المتحركه «» "..(redis:get(ELMOSLM..'mute_gif'..msg.chat_id_) or 'false')
.."\n⋆ الدردشه «» "..(redis:get(ELMOSLM..'mute_text'..msg.chat_id_) or 'false')
.."\n⋆ الانلاين «» "..(redis:get(ELMOSLM..'mute_inline'..msg.chat_id_) or 'false')
.."\n⋆ الالعاب «» "..(redis:get(ELMOSLM..'mute_game'..msg.chat_id_) or 'false')
.."\n⋆ الصور «» "..(redis:get(ELMOSLM..'mute_photo'..msg.chat_id_) or 'false')
.."\n⋆ الفيديو «» "..(redis:get(ELMOSLM..'mute_video'..msg.chat_id_) or 'false')
.."\n⋆ البصمات «» "..(redis:get(ELMOSLM..'mute_audio'..msg.chat_id_) or 'false')
.."\n⋆ الصوت «» "..(redis:get(ELMOSLM..'mute_voice'..msg.chat_id_) or 'false')
.."\n⋆ الملصقات «» "..(redis:get(ELMOSLM..'mute_sticker'..msg.chat_id_) or 'false')
.."\n⋆ الجهات «» "..(redis:get(ELMOSLM..'mute_contact'..msg.chat_id_) or 'false')
.."\n⋆ التوجيه «» "..(redis:get(ELMOSLM..'mute_forward'..msg.chat_id_) or 'false')
.."\n⋆ الموقع «» "..(redis:get(ELMOSLM..'mute_location'..msg.chat_id_) or 'false')
.."\n⋆ الملفات «» "..(redis:get(ELMOSLM..'mute_document'..msg.chat_id_) or 'false')
.."\n⋆ الاشعارات «» "..(redis:get(ELMOSLM..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n⋆ الكيبورد «» "..(redis:get(ELMOSLM..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⋆*`اعدادات اخرى : `"
.."\n\n*⋆*الترحيب «» "..welcomex
.."\n*⋆*الردود «» "..replayx
...
.."\n*⋆*الويب «» "..(redis:get(ELMOSLM..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*⋆*الماركدوان «» "..(redis:get(ELMOSLM..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*⋆*البوتات بالطرد «» "..(redis:get(ELMOSLM..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*⋆*البوتات «» "..(redis:get(ELMOSLM..'lock_bots'..msg.chat_id_) or 'false')
.."\n*⋆*عدد التكرار «» "..(redis:get(ELMOSLM..'num_msg_ELMOSLM'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⋆*اعدادات التقـييد :\n"
.."\n*⋆*التقييد بالتوجيه «» "..(redis:get(ELMOSLM..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد بالصور «» "..(redis:get(ELMOSLM..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد بالروابط «» "..(redis:get(ELMOSLM..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد بالمتحركه «» "..(redis:get(ELMOSLM..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد الفيديو «» "..(redis:get(ELMOSLM..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
